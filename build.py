...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.oxgcp.clearcookies.js')
	...
	f = os.path.join(cwd,'Classes','ComOxgcpClearcookiesModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.oxgcp.clearcookies.js']
